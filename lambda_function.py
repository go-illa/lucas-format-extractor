...
def lambda_handler(event, context):
    ...
    print(f"Downloading file s3://{bucket}/{key} to {download_path}")
    ...
    # 3. Process the file
    print("Processing the downloaded file...")
    process_client_file(
    ...
    # 4. Upload the transformed file to the output bucket
    ...
    print(f"Uploading transformed file to s3://{output_bucket}/{output_key}")
